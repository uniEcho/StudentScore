...
public class Constant {
    ...
    //统一返回码--成功
    public static String SUCCESS_RETURN_CODE = "0";
    //统一返回码--失败
    public static String FAILURE_RETURN_CODE = "-9999";
    //统一返回码--已存在
    public static String HASE_RETURN_CODE = "1";

    public static String SWAGGER = "/swagger-ui";

    public static  String API_DOCS = "/v3/api-docs/";

    public static String KNIFE = "/doc.html";
